...
\section{Introduction}
	...
	2. As we do not have the luxury of i.i.d. draws, for which the consistency of the estimator of Chatterjee's correlation holds (See [paper]),
	...
	Some ideas are presented (See Section 6) inspired by the proof of consistency in [paper] of the i.i.d. estimator on how one should go about it.
...
\section{Proof sketch of Theorem 4.1 for correlated samples}
	Chatterjee presented the complete proof of Theorem 4.1 in [paper], where the samples drawn from $(X, Y)$ are i.i.d.
