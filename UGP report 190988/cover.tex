...
\author{Vivek Kumar Singh\\(BS/MTH/190988)\\\\\\\textbf{Supervisor:} Dr. Dootika Vats}
\date{\today}
...
\makeatletter
    \begin{titlepage}
        \begin{center}
            ...
            {\large  Vivek Kumar Singh}\\[4ex]
            {\large BS/MTH/190988}\\[4ex]
            {\large \textbf{Supervisor:} Dr. Dootika Vats}\\[20ex]
            \includegraphics[height=5cm]{iitk_logo.jpg}\\[20ex] 
